...
export const SessionHeader: React.FC<SessionHeaderProps> = ({ isOnline, operatorName }) => {
  return (
    <header className="scan-session-header h-14 bg-white border-b border-gray-200 flex items-center justify-between px-6 shrink-0">
      ...
      <div className="scan-session-meta flex items-center gap-4">
        <div className={`scan-session-status flex items-center gap-2 px-3 py-1.5 rounded-full border ${isOnline ? 'bg-green-50 border-green-100' : 'bg-red-50 border-red-100'}`}>
        ...
        {operatorName && (
          <div className="scan-session-operator flex items-center gap-3 px-3 py-1.5 rounded-full border border-gray-200 bg-gray-50">
