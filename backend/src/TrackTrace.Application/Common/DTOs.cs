...
public record ScanRequest(Guid OrderId, string RawCode, Guid StationId, string Mode = "AutoGenerated", Guid? ActiveCartonId = null);

public record TransferCartonRequest(Guid? TargetStationId, Guid? TargetUserId);
public record VoidCartonRequest(string Reason);
...
public record CartonDto(
    ...
    string Mode = "AutoGenerated",
    Guid? PrePrintBatchId = null,
    int PrintCount = 0,
